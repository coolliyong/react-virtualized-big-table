...
class RankSortableColumn extends AbstractSortableColumn {
  ...
  private toRank(str: string) {
    ...
    return (
      RankSortableColumn.TITLES[title] * 100 +
      (side === "e" ? 0 : 1) +
      parseInt(rank, 10) * 2
    );
  }
    ...
    return (
      <Menu>
        ...
        <MenuItem
          icon="sort-desc"
          onClick={() =>
            sortColumn(this.index, this.transformCompare(this.toWins, true))
          }
          text="Sort Wins Desc"
        />
        <MenuItem
        ...
        <MenuItem
          icon="sort-desc"
          onClick={() =>
            sortColumn(this.index, this.transformCompare(this.toTies, true))
          }
          text="Sort Ties Desc"
        />
      </Menu>
